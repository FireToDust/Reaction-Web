...
1. **Verify Compliance with Development Principles**
   - Check that code and documentation follow docs/development/development-principles.md
...
2. **Enforce Documentation Standards**
   - Verify adherence to docs/development/documentation-structure.md
